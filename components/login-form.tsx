    ...
    <Card className="w-full max-w-md bg-white shadow-lg">
      <CardContent className="p-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 text-sm">¡Te extrañamos! Introduce tus datos.</p>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-medium py-2 px-4 rounded-md transition-colors flex items-center justify-center gap-2"
          >
